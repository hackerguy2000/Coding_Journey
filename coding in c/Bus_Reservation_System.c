// CODE TO MAKE A E-TRANSPORT LOGISTIC SYSTEM //
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
char ch[10][130] = {"FedeX_E Transport", "DTDC_E Transport", "Patel_E Logistics", "Agarwal_E Logistics", "International_E Logistics", "Express_E Logistics"}; // The 1st subscript [] represent the number of string you want in your array & the 2nd subscript[] represent the length of each string
char name[32][100] = {'\0'};
char number[32][2] = {'\0'};
int num1[32] = {0};
int trno;
void List_Transport(); // for list of Transport available
...
int main()
{
    ...
    do
    {
        system("cls");
        printf("\n\n\n");
        printf("====================================== WELCOME E-LOGISTICS TRANSPORATION SYSTEM ======================================\n\n\n");
        printf("-:::NOW SEND YOUR ANY BULK GOODS OR PACKAGE PRODUCTS AT ANY CORNER OF INDIA :::-");
...
void List_Transport()
{
    system("cls");
    printf("\n\n\n");
    printf("=========================================== Transport & Logistics List  ============================================\n\n\n");
    printf("\t\t\t\t\t[1]  =>  %s\n", ch[0]);
    printf("\n");
    printf("\t\t\t\t\t[2]  =>  %s\n", ch[1]);
    printf("\n");
