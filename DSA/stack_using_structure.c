...
int main()
{
    ...
    printf("The popped element of the stack is:::%d\n", pop(stack));
    printf("The size of the stack now::%d\n", size(stack));
    printf("whether the stack is full or not ::%d\n", isFull(stack));
    printf("Whether the stack is empty or%d\n", isEmpty(stack));
